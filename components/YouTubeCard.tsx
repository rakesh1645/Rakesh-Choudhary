...
export default function YouTubeCard() {
  return (
    <div className="about-blog-box info-box shadow-box h-full p-6 flex flex-col justify-between relative group w-full overflow-hidden bg-gradient-to-b from-red-600 via-red-700 to-red-900 border-red-500/30">
      <a
      ...
      <div className="w-full h-36 flex items-center justify-center relative z-10 my-2">
